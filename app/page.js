      ...
      <style>{`
        ...
        .neon-name:hover {
          text-shadow:
            ...
            0 0 28px rgba(96,165,250,0.70),
            0 0 56px rgba(96,165,250,0.40),
        ...
        <div className="max-w-5xl mx-auto px-6 pt-32 pb-24 relative z-10">
          ...
          <section className="mb-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight tracking-tight">
              ...
              <br />
              <span className="text-white/30 text-3xl md:text-5xl font-bold">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/projects"
                className="px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm transition-all duration-200 hover:shadow-lg hover:shadow-blue-600/30">
                View Projects ↗
              </Link>
              <Link href="/about"
                className="px-6 py-3 rounded-xl bg-white/[0.05] border border-white/10 hover:bg-white/[0.09] text-white font-semibold text-sm transition-all duration-200">
                About Me
              </Link>
              <a href="/resume.pdf" download
                className="px-6 py-3 rounded-xl bg-white/[0.05] border border-white/10 hover:bg-white/[0.09] text-gray-300 font-semibold text-sm transition-all duration-200">
                Resume ↓
              </a>
            </div>
          </section>
              ...
              {projects.map((p, i) => (
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-400 leading-snug">{p.tagline}</p>
                    </div>
                    <span className="shrink-0 text-xs font-bold px-2.5 py-1 rounded-full border whitespace-nowrap"
                      style={{
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 bg-white/[0.02] border border-white/[0.07] rounded-2xl p-6">
            <div>
              <p className="text-xs uppercase tracking-widest text-gray-600 mb-1.5 font-medium">Currently</p>
              <p className="text-white font-semibold">Building ResumeAI &amp; deepening Full Stack skills</p>
              <p className="text-gray-500 text-sm mt-1">Physics Wallah Skills — Full Stack Development Specialization</p>
            </div>
            <Link href="/projects"
              className="shrink-0 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold transition-all duration-200 whitespace-nowrap">
              All Projects →
            </Link>
          </div>
