...
export const metadata = {
  ...
  description: "Portfolio of Vardhan Doharey — Full Stack Developer based in Lucknow. Building things with React, Next.js & AI.",
  icons: {
    icon: "/favicon.ico",
  ...
  openGraph: {
    title: "Vardhan Doharey | Full-Stack Developer",
    description: "Full Stack Developer building things with React, Next.js & AI.|Contact if you want a custome persnol web-pages",
    url: "https://vardhan.is-a.dev",
    siteName: "Vardhan Doharey",
    type: "website",
  },
};
    ...
    <html lang="en">
      <body className="bg-[#0a0a12] text-white antialiased">
        ...
        <style>{`
          ...
          .social-github:hover {
            color: #e2e8f0; border-color: rgba(226,232,240,0.4);
