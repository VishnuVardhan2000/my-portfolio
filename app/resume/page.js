...
/* ── Gold RPG card with cursor spotlight + corner brackets ── */
  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* card hover lift — same as original */
        .gold-card {
          position: relative;
          border-radius: 1rem;
      ...
      <main
        className="min-h-screen bg-[#0a0a12] text-white px-4 md:px-8 py-12"
          ...
          <div className="fade-up flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-12">
            <div>
              ...
              <h1 className="text-3xl md:text-4xl font-black text-white font-mono"
                style={{
                  textShadow:"0 0 10px rgba(251,191,36,0.35), 0 0 30px rgba(251,191,36,0.15)"
                }}>
                Vardhan Doharey
              </h1>
